...
# Use sys.argv to print the file name to the command line, adding a new line character.
print (sys.argv[0], "is designed to count occurances of the letter 'e' in a text file.", "\n")

# Prompt user to input their chosen file or file path on the command line.
Arg = input("Enter a text file name: ")

# Create variables U and L and assign them to the characters 'E' and 'e'.
...
#Lines 34-39: information on splitting lines into 'words' and 'letters' found @
